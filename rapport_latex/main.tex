...
\end{tabular}   % <-- fin du tableau équipe existant
...
Ce rapport est organisé en neuf chapitres. Le \textbf{chapitre~2} présente l'état de l'art
...
\textbf{chapitre~9} conclut et ouvre sur les perspectives.
...
Débit vidéo MJPEG & $\approx$10~fps & Dépend du réseau Wi-Fi \\
Consommation ESP32 (mesure) & $\approx$240~mA & En transmission continue \\
\bottomrule
\end{tabularx}
\end{table}
